...
TableRequestTaskTest::TableRequestTaskTest(const bool expectSuccess) : TestStep(expectSuccess)
{
...
bool
TableRequestTaskTest::runTest(json& inputData, Hanami::ErrorContainer& error)
{
    // create new user
    std::string result;
