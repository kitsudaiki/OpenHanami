...
#[api_operation(
    tag = "network",
    summary = "Get network",
    description = r###"Get information of a network from the database."###,
    error_code = 400,
    error_code = 401,
    error_code = 404,
    error_code = 500
...
pub async fn get_network(
    ...
    context: UserContext,
) -> Result<Json<NetworkResp>, ErrorResponse> {
    let network_data = network_table::get_network(&network_uuid, &context)
        .map_err(|e| map_db_uuid_get_delete_error("network", &network_uuid, e))?;
