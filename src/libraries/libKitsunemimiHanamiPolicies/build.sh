...
echo "###########################################################################################################"
echo ""
get_required_kitsune_lib_repo "libKitsunemimiHanamiCommon" "develop" 4 
echo ""
echo "###########################################################################################################"
...
if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiHanamiPolicies" 1 "run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiHanamiPolicies" 1 ""
fi
