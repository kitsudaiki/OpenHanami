 ...
 */
void
streamDataCallback(void*, Session*, const void*, const uint64_t)
{
 ...
 */
void
standaloneDataCallback(void*, Session* session, const uint64_t blockerId, DataBuffer* data)
{
 ...
 */
void
sessionCreateCallback(Hanami::Session* session, const std::string)
{
 ...
 */
Session_Test::Session_Test() : Hanami::MemoryLeakTestHelpter("Session_Test")
{
