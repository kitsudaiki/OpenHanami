...
get_required_kitsune_lib_repo "libKitsunemimiCommon" "v0.27.0" 4

#-----------------------------------------------------------------------------------------------------------------

if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiCrypto" 4 "run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiCrypto" 4 ""
fi
