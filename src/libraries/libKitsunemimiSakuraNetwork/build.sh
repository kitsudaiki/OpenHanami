...
get_required_kitsune_lib_repo "libKitsunemimiNetwork" "develop" 4

#-----------------------------------------------------------------------------------------------------------------

if [ $1 = "test" ]; then
    # for tests a smaller message-size is defined to easier test multi-block-messages
    build_kitsune_lib_repo "libKitsunemimiSakuraNetwork" 4 "run_tests" "DEFINES+=MAX_SINGLE_MESSAGE_SIZE=1024"
else
    build_kitsune_lib_repo "libKitsunemimiSakuraNetwork" 4 ""
fi
