...
#ifndef HANAMI_STRUCT_VALIDATION_H
#define HANAMI_STRUCT_VALIDATION_H
...
validateStructSizes()
{
    ...
    assert(sizeof(SynapseBlock) == 65536);
    assert(sizeof(Synapse) == 16);
    assert(sizeof(BrickBlock) == 67584);
    assert(sizeof(BlockConnection) == 2048);
